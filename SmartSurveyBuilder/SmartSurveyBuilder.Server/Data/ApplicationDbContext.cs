...
using SmartSurveyBuilder.Server.Modules.LogicModule.Models;
...
namespace SmartSurveyBuilder.Server.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<SurveySettings> SurveySettings { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SurveySettings>(entity =>
            {
